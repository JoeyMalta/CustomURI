...
public:
	...
	/// @returns New Credential.
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Firebase|Auth|Credential|Facebook")
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Firebase|Auth|Credential|Game Center")
	...
	/// @returns New Credential.
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Firebase|Auth|Credential|GitHub")
	...
	/// @returns New Credential.
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Firebase|Auth|Credential|Google")
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Firebase|Auth|Credential|PlayGames")
	...
	/// @return New Credential.
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Firebase|Auth|Credential|Twitter")
